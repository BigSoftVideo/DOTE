## Import transcript from 3rd party sources (JSON file)  <a id='import-json'></a>
...
To initiate the import in _DOTE_, select `Import` from the `File` menu.
Select `Import from JSON`.

After selecting a file from your computer, an error will be given if the JSON format is not recognised.
...
[![Import JSON](images/import/importJSON.png)](images/import/importJSON.png)
