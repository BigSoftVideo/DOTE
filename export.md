...
### Exporting a Project to file with native DOTE format <a id='export-project'></a>
...
### Exporting a Transcript to a file with native DOTE format <a id='export-transcript'></a>
