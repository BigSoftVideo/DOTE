...
#### The ribbon <a id='function'></a>

The basic functions for [version control](versioncontrol.md) and [managing media](media-manager.md) are easily accessible via these ribbon buttons.
