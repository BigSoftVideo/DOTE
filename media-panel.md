...
[![Media panel](images/video/video.png)](images/video/video.png)
...
[![Media panel](images/video/slider2.png)](images/video/slider2.png) Save viewport

[![Media panel](images/video/slider3.png)](images/video/slider3.png) Freeview
...
If at any time you try to create, edit or move a video-cue when the [lock video to video-cue](media-panel.md#video-tips) slider button is not selected, then _DOTE_ will warn you that video-cues will not be tracked in the media panels unless you toggle them on in one or both media panels.
